...
DISCORD_BOT_TOKEN = "OTk4ODAxMTY0OTAyNjEzMDIy.Gt7XGo.0NAJbxTnJu9G5oMHyiMxr7EeOBNtdFMgaQ8F1k"

# Define URLs for profile picture and/or banner. Leave one blank "" if you only want to do the other one
PROFILE_IMAGE_URL = "https://media1.tenor.com/m/EQCT1ywCR0wAAAAd/alya-alisa-mikhailovna-kujou.gif"
BANNER_IMAGE_URL = ""
